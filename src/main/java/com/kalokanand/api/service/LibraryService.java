package com.kalokanand.api.service;

import com.kalokanand.api.exception.EntityNotFoundException;
import com.kalokanand.api.model.*;
import com.kalokanand.api.model.request.AuthorCreationRequest;
import com.kalokanand.api.model.request.BookCreationRequest;
import com.kalokanand.api.model.request.BookLendRequest;
import com.kalokanand.api.model.request.MemberCreationRequest;
import com.kalokanand.api.repository.AuthorRepository;
import com.kalokanand.api.repository.BookRepository;
import com.kalokanand.api.repository.LendRepository;
import com.kalokanand.api.repository.MemberRepository;
...
public class LibraryService {
	...
	public List<String> lendABook(BookLendRequest request) {
		...
		request.getBookIds().forEach(bookId -> {
			...
			Optional<Lend> burrowedBook = lendRepository.findByBookIdAndStatus(bookForId.get().getId(),
					LendStatus.BURROWED);
